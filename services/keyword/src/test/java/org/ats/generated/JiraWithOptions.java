...
public class JiraWithOptions {
  ...
  public void setUp() throws Exception {
    System.out.println("[Start][Suite]{\"name\": \"JiraWithOptions\", \"id\": \"c5a8684b-f9fd-4983-b517-a94c346738be\", \"jobId\" : \"\", \"timestamp\": \""+System.currentTimeMillis()+"\"}");
  ...
  public void tearDown() throws Exception {
    System.out.println("[End][Suite]{\"name\": \"JiraWithOptions\", \"id\": \"c5a8684b-f9fd-4983-b517-a94c346738be\", \"jobId\" : \"\", \"timestamp\": \""+System.currentTimeMillis()+"\"}");
    wd.quit();
  }
  
  
  @Test(priority = 1)
  public void teste3afc1f0() throws Exception {
    System.out.println("[Start][Case]{\"name\": \"test\", \"id\": \"e3afc1f0-84ed-4551-8949-d89b5b27aaf3\", \"timestamp\": \""+System.currentTimeMillis()+"\"} "); 
